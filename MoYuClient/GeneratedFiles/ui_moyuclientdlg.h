...
public:
    ...
    void setupUi(QMainWindow *MoYuClientClass)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral("fish.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral("exit.ico"), QSize(), QIcon::Normal, QIcon::Off);
        actionExit->setIcon(icon2);
        actionAbout = new QAction(MoYuClientClass);
        actionAbout->setObjectName(QStringLiteral("actionAbout"));
        QIcon icon3;
        icon3.addFile(QStringLiteral("help.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral("police.ico"), QSize(), QIcon::Normal, QIcon::Off);
